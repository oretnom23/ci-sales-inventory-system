    ...
    var handleTable = function () {
        ...
        var formadd =   '<form>'+
                            ...
                            '<div class="form-group form-md-line-input">'+
                                '<input type="text" placeholder="Order Number is required." id="form_control_1" class="form-control" name="or_number">'+
        ...
        table.on('click', '.delete', function (e) {
            ...
            var path = window.location.pathname;
            var url = window.location.protocol+'//'+window.location.hostname+'/'+path.split('/')[1]+'/layaway/delete_payment';
            var save = function(){
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                if(data.status){
                    var path = window.location.pathname;
                    var url = window.location.protocol+'//'+window.location.hostname+'/'+path.split('/')[1]+'/layaway/update_payment';
                    $.ajax({
                        url:url,
                        method:'POST',
                        data:{amount:data.amount,id:data.id,or_number:data.or_number,payment_date:data.payment_date},
                        success:function(res){
                            if(res.status){
